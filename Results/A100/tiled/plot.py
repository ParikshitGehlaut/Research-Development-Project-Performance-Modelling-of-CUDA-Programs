...
CSV_INPUT_FILE = "A100_results_tile_dim_16.csv"
PLOT_OUTPUT_FILE = "t16_a100.png"
T_VALUE = 16
...
def setup_plot_style():
    ...
    plt.rcParams.update({
        ...
        'xtick.labelsize': 12,  # CHANGED: Increased from 9 for clear tick numbers
        'ytick.labelsize': 12,  # CHANGED: Increased from 9 for clear tick numbers
        'lines.linewidth': 2.5, # CHANGED: Thicker lines to make data prominent
        'lines.markersize': 7,  # CHANGED: Larger markers for easy viewing
        'axes.linewidth': 1.5,
    })
...
def calculate_theoretical_model(warps_per_sm, T):
    ...
    """
    # --- Model Parameters (for A100 from the script) ---
    PEAK_PERF_CONSTANT = 9745.92
    LATENCY_BASE = 466
    LATENCY_SCALING_FACTOR = 4
    BANDWIDTH_LIMIT = 0.09927
