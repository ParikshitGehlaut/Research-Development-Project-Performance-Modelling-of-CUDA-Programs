...
def create_plot():
    ...
    # Mathematical perfect scale: 7 cols * 1.0" + 3.0" margin | 4 rows * 1.2" + 3.5" margin
    FIG_W, FIG_H = 10.0, 8.3
    ...
    # Exact mathematically aligned margins for (10x8.3 overall -> 7x4.8 plot area + 2.5 L / 0.5 R / 1.5 T / 2.0 B)
    plt.subplots_adjust(left=0.25, right=0.95, top=0.8193, bottom=0.2410)
