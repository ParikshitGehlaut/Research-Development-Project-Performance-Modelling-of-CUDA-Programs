...
def create_plot():
    ...
    # ------------------------------
    # Fixed figsize for all GPUs — same canvas = same proportions in paper.
    # Memory latency values are 3-digit integers (e.g. 236, 347), so fmt=".0f"
    # gives the shortest display ("236" vs "236.0") and eliminates cell overflow.
    FIG_W, FIG_H = 14, 7
