...
PLOT_OUTPUT_FILE = f"simplistic_kernel_a{ARITH_INTENSITY}_h100.png"

# ── H100 parameters ──
MEM_LAT    = 352
ALU_LAT    = 4
MEM_THRU   = 0.0310     # corrected for 8-byte loads (÷256)
ISSUE_THRU = 4.0
COEFF      = 6402.24    # 32 × 114 × 1.755
...
def batch_generate():
    ...
    for ai in ai_values:
        ...
        if df.empty:
            continue
        out = f"simplistic_kernel_a{ai}_h100.png"
