...
GPU_CONFIGS = {
    ...
    "A100": GPUConfig(
        ...
        n_sms=108,
        clock_ghz=1.410,
        mem_bw_gbps=812.0,        # from memory streaming test
        mem_lat_cycles=244,       # Verified from MemLatency test
    ...
    "H100": GPUConfig(
        ...
        n_sms=114,
        clock_ghz=1.755,
        mem_bw_gbps=1083.12,      # from memory streaming test
        mem_lat_cycles=347,       # Verified from MemLatency test
